	...
	<div class="plugin-data-filter row">
		...
		<div class="col-sm-2">
			...
			<select id="data-limit" class="">
				<option value="3" <?php if( get_option( 'service_list_limit' ) == 3 ) _e( "selected='selected'" ); ?> >3</option>
				<option value="10" <?php if( get_option( 'service_list_limit' ) == 10 ) _e( "selected='selected'" ); ?> >10</option>
				<option value="25" <?php if( get_option( 'service_list_limit' ) == 25 ) _e( "selected='selected'" ); ?> >25</option>
			</select>
		</div>
	</div>
...
<div class="plugin-content-link">
	<a href="?page=cbus-services&action=create-new">
...
jQuery(document).ready( function($) {
	...
	$( "#data-limit" ).on( "change", function() {
		...
		// doRetrievePagination( "service", limit, 0, searchfor, "#plugin-data-pagination" );
		doRetrievePagination( data, "#plugin-data-pagination" );
